    ...
    <form action="/users/modify" id="modify-form" method="POST">
        <fieldset class="insert">
            ...
            <div class="form-group">
                ...
                <input class="inputA" name="userName" id="inputNickName" type="text" placeholder="새 NICKNAME">
            </div>
            <div>
            ...
            <div class="form-group">
                ...
                <input class="inputA" name="userPw" id="pw1" type="password" placeholder="새 비밀번호">
            </div>
            <div class="form-group">
            ...
            <div class="checkmsg">
                ...
                <br>
                <p>
                    <button type="button" class="btn btn-primary btn-lg" id="modify-done">완료</button>
                </p>
        </fieldset>
    </form>
